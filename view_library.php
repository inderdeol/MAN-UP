...
<?php 
 ...
 $statement = $conn->prepare("SELECT * FROM library WHERE id=:id");
...
<div style="width: 710px; margin: 0 auto;>
  <div class="bacon-blog-post bacon-shadow">
    <div class="bacon-blog-post-inner">
      <h2><a href="view-library?id=<?=$row['id']?>"><?=$row['title']?></a></h2>
      <hr>
      <p><?=$row['text']?></p>
      <a href="/library/<?=$row['file']?>"><i class="fa fa-file" aria-hidden="true"></i>  Download</a>
        <hr>
    </div>
  </div>
</div>
<?php }elseif($stmt->rowCount() > 0){
    while($library = $stmt->fetch(PDO::FETCH_BOTH)){
    ?>
...
<div style="width: 710px; margin: 0 auto;>
  <div class="bacon-blog-post bacon-shadow">
    <div class="bacon-blog-post-inner">
      <h2><a href="view-library?id=<?=$library['id']?>"><?=$library['title']?></a></h2>
      <a href="/library/<?=$library['file']?>"><i class="fa fa-file" aria-hidden="true"></i>  Download</a>
        <hr>
    </div>
  </div>
</div>
