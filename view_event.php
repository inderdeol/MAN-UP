...
<?php 
 ...
 $statement = $conn->prepare("SELECT * FROM event WHERE id=:id");
...
<div style="width: 710px; margin: 0 auto;>
  <div class="bacon-blog-post bacon-shadow">
    <img src="/events/<?=$row['image']?>" class="wp-post-image" width="100%">
...
<div style="width: 710px; margin: 0 auto;>
  <div class="bacon-blog-post bacon-shadow">
    <img src="/events/<?=$news['image']?>" class="wp-post-image" width="100%">
    <div class="bacon-blog-post-inner">
